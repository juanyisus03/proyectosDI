...
namespace UD5_EjemploBBDD.LucenaBitDataSetTableAdapters {
...
SELECT Id, Nombre, Precio, Categoria, Cantidad FROM Articulos WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::UD5_EjemploBBDD.Properties.Settings.Default.LucenaBitConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Nombre, Precio, Categoria, Cantidad FROM dbo.Articulos where Categoria" +
                "  = \'Periféricos\'";
